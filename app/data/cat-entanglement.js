...
New progress (August 2026): Tabia, Chen and Hsieh proved that a distinguished one-copy-undistillable state in the canonical two-parameter family of DiVincenzo et al. is already two-copy distillable in every local dimension $d\geq3$. Their uniform witnesses also certify an open neighborhood, while separate three-copy witnesses enlarge the known distillable region. This disproves the conjecture that the entire one-copy-undistillable region of that family stays undistillable for arbitrarily many copies, but neighboring two-copy-undistillable states and the general NPT question remain unresolved.

**Authors' statement (unverified):** According to the disclosure, ChatGPT using the GPT-5.6 Thinking model would have substantially assisted the scientific reasoning, numerical-filter search, exact two- and three-copy certificates, and organization of the arguments, in interactions initiated and directed by Tabia. The authors say they independently reconstructed and verified the calculations and take responsibility for the result.
...
If NPT bound entanglement exists, distillability is non-additive and non-convex in striking ways (two undistillable states can become distillable together — 'activation'). The problem is sharp: a single explicit NPT undistillable state, or a proof that none exists, resolves it. Related: E2, E5.`,
    refs: [
      ...
      { label: "Tabia, Chen & Hsieh, 'Two-copy distillability of one-copy-undistillable negative-partial-transpose states in every dimension' (2026)", url: "https://arxiv.org/abs/2608.08836" },
    ] },
...
**Further progress (31 July 2026):** Wu and Zou analyzed the first unresolved three-copy Werner endpoint. They prove endpoint nonnegativity for every positive-semidefinite rank-two coefficient operator and the full normal rank-two sector in arbitrary finite local dimensions, plus several genuinely nonnormal cases. These are sharp partial results; they do not settle the full $n=3$ case.

**Authors' statement (unverified, three-copy paper):** The manuscript contains no declaration of generative-AI use. In the absence of such a disclosure, the work would appear human-authored, but this catalogue cannot establish that no AI tools were used.
...
A resolution of this specific family settles E1. Related: E1.`,
    refs: [
      ...
      { label: "Wu & Zou, 'Sharp Plucker Geometry for Three-Copy Werner Distillation' (2026)", url: "https://arxiv.org/abs/2608.02647" },
    ] },
...
Whether the quantum entropy cone for $n\ge4$ has new independent (constrained) inequalities beyond the known ones is open. Partial results (Linden–Winter; Cadney–Linden–Winter; Linden–Matúš–Ruskai–Winter) found constrained inequalities and some new structure, but the cone is not determined. A resolution — either a new provable inequality or a proof that none exist — is sharp. Related: E12.`,
  ...
  { id: "E14", cat: "entanglement", horizon: "sharp", status: "improved",
...
New progress (August 2026): Shi, Zhang, Zhao and Li completed the seven-party row, proving that $\mathrm{AME}(7,d)$ exists exactly when $d\geq3$. Independently, Bevins and Bidav gave explicit code constructions for five previously open cases: $\mathrm{AME}(12,5)$, $\mathrm{AME}(18,11)$, $\mathrm{AME}(18,13)$, $\mathrm{AME}(17,11)$ and $\mathrm{AME}(17,13)$. These close specific cases, not the full $(n,d)$ classification.

**Authors' statements (unverified):** Shi et al. state that the $\mathrm{AME}(7,2q)$ construction for odd $q$ would have been developed with GPT-5.6, then independently verified in full by the authors. Bevins and Bidav state that, under their direction, Claude Fable 5 and ChatGPT 5.6 Sol would have been used extensively for the entire computational search, method development and implementation, exact verification, bibliographic checks and manuscript preparation; both authors say they independently reviewed the constructions, computations and full text. On these declarations, neither paper should be described as purely autonomous AI work.
...
A complete table of admissible $(n,d)$ — with constructive existence or nonexistence proofs — is still missing, and connects directly to open questions on MDS codes. Related: N1 (design-type structures).`,
    refs: [
      ...
      { label: "Shi et al., 'Complete Existence Classification of Seven-Partite Absolutely Maximally Entangled States' (2026)", url: "https://arxiv.org/abs/2608.01011" },
      { label: "Bevins & Bidav, 'Symmetry-guided constructions of absolutely maximally entangled states in five open cases' (2026)", url: "https://arxiv.org/abs/2608.05781" },
    ] },
