...
Published progress (August 2026; preprint February 2026): Kattemölle, Gulácsi and Burkard proved that Pauli twirling can turn noise generated by a Markovian-divisible process into a channel that is not embeddable in a Pauli semigroup. For positive nondegenerate Pauli eigenvalues, they characterize failure of channel-semigroup Markovianity by the occurrence of a negative Pauli–Lindblad parameter. This operationally relevant separation sharpens the relation between two notions of memory, but does not unify the full hierarchy of definitions.
...
**Authors' statements (unverified, further papers):** Neither manuscript contains a declaration of generative-AI use; this catalogue cannot establish that no such tools were used.
